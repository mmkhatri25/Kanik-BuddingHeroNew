...
namespace Ui
{
	public class UiManager : MonoBehaviour
	{
		...
		public void Init(Simulator sim, SoundManager soundManager)
		{
            ...
            //{
                     this.sim.GainCurrency(CurrencyType.GOLD, 10000000000000000000);
                          this.sim.GainCurrency(CurrencyType.GEM, 10000000000000000000);
                          this.sim.GainCurrency(CurrencyType.AEON, 10000000000000000000);
                        //  this.sim.GainCurrency(CurrencyType.CANDY, 10000000000000000000);
                          this.sim.GainCurrency(CurrencyType.MYTHSTONE, 10000000000000000000);
                          this.sim.GainCurrency(CurrencyType.SCRAP, 10000000000000000000);
                          this.sim.GainCurrency(CurrencyType.TOKEN, 10000000000000000000);
                        //  this.sim.GainCurrency(CurrencyType.TRINKET_BOX, 10000000000000000000);
				...
				if (challenge is ChallengeStandard)
				{
					...
					else
					{
                        ...
                        //  this.sim.GainCurrency(CurrencyType.CANDY, 10000000000000000000);
                          ...
                          this.sim.GainCurrency(CurrencyType.TOKEN, 10000000000000000000);
                        //  this.sim.GainCurrency(CurrencyType.TRINKET_BOX, 10000000000000000000);
                    //print("gold Before - "+ this.sim.GetGold().GetString());
                    //int gold = int.Parse(this.sim.GetGold().GetString());
                    //if(gold< 10000)
                          //this.sim.GainCurrency(CurrencyType.GOLD, 1000);
                          
                    //print("gold after - "+ this.sim.GetGold().GetString());
